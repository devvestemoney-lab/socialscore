      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-display font-bold text-white">Billing & Revenue</h1>
              <p className="text-sm text-muted-foreground">API usage billing, invoices, and revenue tracking</p>
            </div>
          </div>
          <button className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white/10 hover:bg-white/15 text-white text-sm font-medium transition-colors">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="p-6 rounded-xl bg-white/5 border border-white/10">
            <h3 className="font-semibold text-white mb-4">Monthly Revenue by Tenant</h3>
          ...
          <div className="p-6 rounded-xl bg-white/5 border border-white/10 space-y-4">
            ...
            {[
              ...
              <div key={plan} className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <div className="flex flex-wrap gap-1">
                  {features.map(f => <span key={f} className="text-xs px-2 py-0.5 rounded-full bg-white/10 text-muted-foreground">{f}</span>)}
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="rounded-xl bg-white/5 border border-white/10 overflow-hidden">
          <div className="p-4 border-b border-white/10">
            <h3 className="font-semibold text-white">Tenant Invoices — This Month</h3>
          </div>
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <tbody>
                {(tenants || []).map((t: any) => (
                  <tr key={t.tenantId} className="border-b border-white/5 hover:bg-white/5 transition-colors">
                    ...
                    <td className="py-3 px-4 text-sm text-white font-medium">{t.monthCalls}</td>
                    <td className="py-3 px-4 text-sm text-white font-semibold">{t.monthRevenue.toFixed(2)}</td>
                    <td className="py-3 px-4">
