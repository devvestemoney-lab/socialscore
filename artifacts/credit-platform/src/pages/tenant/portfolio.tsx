    ...
    <Layout>
      <div className="space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-display font-bold text-white">Portfolio Monitoring</h1>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="p-5 rounded-xl bg-white/5 border border-white/10">
            <h3 className="font-semibold text-white mb-4">Portfolio Exposure Trend</h3>
          ...
          <div className="p-5 rounded-xl bg-white/5 border border-white/10">
            <h3 className="font-semibold text-white mb-4">Risk Segmentation</h3>
              ...
              <div className="flex-1 space-y-2">
                {riskSegmentation.map((seg: any) => (
                  <div key={seg.tier} className="flex items-center justify-between">
                    ...
                    <span className="text-xs font-medium text-white">{seg.count}</span>
                  </div>
                ))}
              </div>
            </div>
        ...
        {/* Default Rate Trend */}
        <div className="p-5 rounded-xl bg-white/5 border border-white/10">
          <h3 className="font-semibold text-white mb-4">Monthly Default Rate (%)</h3>
        ...
        <div className="rounded-xl bg-white/5 border border-white/10 overflow-hidden">
          <div className="p-4 border-b border-white/10 flex items-center gap-2">
            ...
            <h3 className="font-semibold text-white">Early Warning Signals</h3>
              ...
              <table className="w-full">
                ...
                <tbody>
                  {earlyWarnings.map((w: any) => {
                    ...
                    return (
                      <tr key={w.loanId} className="border-b border-white/5 hover:bg-white/5 transition-colors">
                        <td className="py-3 px-4 text-sm font-medium text-white">{w.customerName}</td>
                        ...
                        <td className="py-3 px-4 text-sm text-white">ZMW {w.outstandingBalance.toLocaleString()}</td>
                        <td className="py-3 px-4 text-sm text-white font-bold">{w.missedPayments}</td>
